      ...
      <div className="mb-12">
        ...
        <div className="space-y-0 w-full">
          ...
          >
            ...
            <span className="text-xs font-mono uppercase tracking-wider" style={{ color: THEME.colors.text.secondary }}>
              Actions
            </span>
            </div>
          </div>
          ...
          {loading ? (
              <div className="py-12 text-center text-sm font-mono" style={{ color: THEME.colors.text.muted }}>
                Loading...
              </div>
          ) : tickets.length === 0 ? (
              <div className="py-12 text-center text-sm font-mono" style={{ color: THEME.colors.text.muted }}>
              ...
              tickets.map((ticket) => (
                  <div
                      ...
                      style={{
                        borderBottom: `1px solid ${THEME.colors.border.hairline}`,
                        // V2: selection highlight
                        // backgroundColor: selectedIds.has(ticket.id) ? THEME.colors.surface.elevated : 'transparent',
                        backgroundColor: 'transparent',
                      }}
                  >
                    <div className="min-w-0">
                      <div className="font-mono text-sm mb-1 truncate" style={{ color: THEME.colors.text.primary }}>
                        {ticket.title}
                      </div>
                      <div className="text-xs font-mono truncate" style={{ color: THEME.colors.text.muted }}>
                        {ticket.slug}
                      </div>
                    </div>
